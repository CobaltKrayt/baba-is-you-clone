...
class PlacementTests extends SnakeTestSuiteBase {
  ...
  test("testStartCorrectly") {
    checkGame(
      ...
      hint = " The baba should begin in the top left, heading east, and be three cells long."
    )
  }
  ...
  test("testNoRoomForApple") {
    checkGame(
      ...
      , hint = "No apple should be placed if the entire playing field is filled with the baba body."
    )
  }
}
